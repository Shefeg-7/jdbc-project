...
-- If you are giving a single work as the name of the column, you can use it without double quotation. If more than one, use double quotation if we want to have  a space.
select * from EMPLOYEES;
